    ...
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeSkill", x => new { x.EmployeesEmployeeId, x.SkillsID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkerEmployeeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_WorkerEmployeeId",
                table: "Reviews",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Works_WorkerEmployeeId",
                table: "Works",
                column: "WorkerEmployeeId");
        }
